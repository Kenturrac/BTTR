...
DZAI_respawnTMaxL = 2700;

//Classnames of land vehicle types to use. (Default: "UAZ_Unarmed_TK_EP1")
DZAI_vehTypes = ["UAZ_Unarmed_TK_EP1","hilux1_civil_3_open_EP1","SUV_TK_CIV_EP1","HMMWV_DZ","UAZ_Unarmed_UN_EP1","SUV_Silver","SkodaGreen","SkodaRed","SkodaBlue","SUV_Camo","SUV_Silver","Lada1","LandRover_CZ_EP1","HMMWV_Armored"];
...
DZAI_banAIWeapons = ["M107_DZ","BAF_AS50_scoped","ksvk_DZE"];										
...
//AI skill settings level 1 *edit by Cold*(Skill, Minimum skill, Maximum skill). Baseline skill level: 0.55
DZAI_skill0 = [	
...
DZAI_heliCrewSkills = [	
	["aimingAccuracy",5.00,5.00],
	["aimingShake",5.00,5.00],
	["aimingSpeed",5.00,5.00],
	["endurance",5.00,5.00],
	["spotDistance",5.00,5.00],
	["spotTime",5.00,5.00],
	["courage",5.00,5.00],
	["reloadSpeed",5.00,5.00],
	["commanding",5.00,5.00],
	["general",5.00,5.00]
];
