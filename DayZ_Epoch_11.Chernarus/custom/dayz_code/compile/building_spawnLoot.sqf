private ["_obj","_plotpoles","_checkRange","_type","_config","_positions","_iPos","_nearBy","_itemType","_itemTypes","_lootChance","_weights","_cntWeights","_index","_itemTypesSmall","_positionsSmall"];
//_t1 = diag_tickTime;

_obj = 			_this select 0;

// Check if plotpole is in range
_checkRange = ((DZE_PlotPole select 0) + 15);
_plotpoles = position _obj nearObjects ["Plastic_Pole_EP1_DZ", _checkRange];

if (count(_plotpoles) == 0) then {
